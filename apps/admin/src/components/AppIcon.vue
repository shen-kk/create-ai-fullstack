...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'deploy'">
      <path d="M12 2c3 2 5 5 5 8v3l2 2v2h-5l-2 5-2-5H5v-2l2-2v-3c0-3 2-6 5-8Z" />
    ...
    <template v-else-if="name === 'chevron'"><path d="m6 9 6 6 6-6" /></template>
