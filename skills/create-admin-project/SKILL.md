...
3. For a new user project, run `npm create aiforge@latest <project-name>` and answer its interactive prompts; do not ask the user to clone the repository or run `template:init` separately.
